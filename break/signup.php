...
<body>
    ...
    <!-- <div id="login">
        ...
        <section> <span></span> <span></span> <span></span> <span></span> <span></span> <span></span> <span></span>
            ...
            <div class="signin">
                <div class="content">
                    <h2>SIGN UP into BREAK</h2>
                    <form action="sign_up_php.php" method="POST">
                        <div class="inputBox">
                            <input type="text" name="reg_login" id="reg_login" required><br> <i>Name (login)</i>
                        </div>
                        <div class="inputBox">
                            <input type="text" name="reg_nick" id="reg_nick" required><br> <i>Nick</i>
                        </div>
                        <div class="inputBox">
                            <input type="reg_password" name="reg_password" id="reg_password" required><br> <i>Password</i> 
                        </div>
                        <div class="links"><a href="index.php">Log in</a>
                        </div>
