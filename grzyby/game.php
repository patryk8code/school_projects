            ...
            <div>
                ...
                <table id="shop">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>sell for:</th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_0">1</span></th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_1">2</span></th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_2">3</span></th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_3">4</span></th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_4">5</span></th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_5">6</span></th>
                            <th onclick="sell(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_sell_6">6</span></th>
                        </tr>
                        <tr>
                            <th>In Shop:</th>
                        ...
                        <tr>
                            <th>upgrade for:</th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_0">1</span></th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_1">2</span></th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_2">3</span></th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_3">4</span></th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_4">5</span></th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_5">6</span></th>
                            <th onclick="buy(this)" onmouseover="shop_mouse_in(this)" onmouseout="shop_mouse_out(this)"><span id="shop_buy_6">6</span></th>
                        </tr>
                    </tbody>
                </table>
            </div>
